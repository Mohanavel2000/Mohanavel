...
$("#start-btn").click(function(){
  ...
  html2canvas($(".faded")[0]).then(canvas => {
    ...
    $(".faded").children().not(".dust").fadeOut(3500);
    //apply animation
...
$('#start-btn').click(function(){
  $('#snap-it').trigger('play');
});
$('#hire').click(function(){ 
  var mailId ='vemohan15@mail.com';
  ...
  var domain_ml = document.getElementById('ml').checked;
  ...
  var body = 'Recruiter Name : '+recruiter_name+'%0ARecruiter Mail :'+recruiter_mail+
              '%0ARecruiter Website :'+recruiter_website+'%0AMachine Learning : '+domain_ml+
